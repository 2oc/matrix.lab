...
lang en_US.UTF-8
keyboard us
network --onboot yes --device eth0 --bootproto static --ip 10.10.10.203 --netmask 255.255.255.0 --gateway 10.10.10.10 --noipv6 --nameserver 10.10.10.1023 --hostname rh6clnt11.matrix.lab --domain matrix.lab
