...
# Network information
network --bootproto=static --device=eth0 --gateway=10.10.10.1 --ip=10.10.10.121 --netmask=255.255.255.0 --activate --nameserver=10.10.10.99 --hostname=rh7idm01.matrix.lab 
...
#
volgroup vg_rh7idm01 pv.03
#
logvol /    --fstype=xfs --vgname=vg_rh7idm01 --name=lv_root --label="root" --size=8192
logvol swap --fstype=swap --vgname=vg_rh7idm01 --name=lv_swap --label="swap" --size=2048
logvol /home --fstype=xfs --vgname=vg_rh7idm01 --name=lv_home --label="home" --size=1024
logvol /tmp --fstype=xfs --vgname=vg_rh7idm01 --name=lv_tmp --label="temp" --size=2048
