...
# Network information
network --bootproto=static --device=eth0 --ip=10.10.10.134 --netmask=255.255.255.0 --gateway=10.10.10.1 --activate --nameserver=10.10.10.121,10.10.10.122 --hostname=rh7osetcd03.matrix.lab 
...
#
volgroup vg_rh7osetcd03 pv.03
#
logvol /    --fstype=xfs --vgname=vg_rh7osetcd03 --name=lv_root --label="root" --size=8192
logvol swap --fstype=swap --vgname=vg_rh7osetcd03 --name=lv_swap --label="swap" --size=2048
logvol /home --fstype=xfs --vgname=vg_rh7osetcd03 --name=lv_home --label="home" --size=1024
