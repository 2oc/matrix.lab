...
# Network information
network --bootproto=static --device=eth0 --ip=10.10.10.137 --netmask=255.255.255.0 --gateway=10.10.10.1 --activate --nameserver=10.10.10.121,10.10.10.122 --hostname=rh7osenod01.matrix.lab 
...
#
volgroup vg_rh7osenod01 pv.03
#
logvol /    --fstype=xfs --vgname=vg_rh7osenod01 --name=lv_root --label="root" --size=8192
...
logvol /var/lib/docker --fstype=xfs --vgname=vg_rh7osenod01 --name=lv_docker --label="docker" --size=1024
